...
// Firestore (modern local cache API)
import {
  initializeFirestore,
  persistentLocalCache,
  persistentMultipleTabManager,
  getFirestore,        // kept for helper types
  doc,
  getDoc,
  setDoc,
  onSnapshot,
...
// Firestore with persistent local cache (replaces enableIndexedDbPersistence)
